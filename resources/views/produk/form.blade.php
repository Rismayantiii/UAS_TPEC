...
<main style="margin-top: 70px">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form action="{{ url('produk/create', @$produk->id) }}" method="POST" enctype=”mutiplart/form-data”>
                    @csrf
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            <select name="kategori_produk" id="kategori_produk" class="form-control">
                                ...
                                <option @selected(old('kategori_produk', @$produk->kategori_produk) == 'Celana') value="Baju">Celana</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            <input value="{{ old('nama_produk', @$produk->nama_produk) }}" type="text" class="form-control" name="nama_produk" 
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            <input value="{{ old('stok', @$produk->stok) }}" type="number" class="form-control" name="stok" 
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            <input value="{{ old('harga_produk', @$produk->harga_produk) }}" type="number" class="form-control" name="harga_produk" 
                            id="harga_produk" placeholder="Harga Produk">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            ...
                            <img src="{{ Storage::url('produk/' . @$produk->foto_produk) }}" class="mb-3" alt="Foto" width="100px" />
                            @endif
